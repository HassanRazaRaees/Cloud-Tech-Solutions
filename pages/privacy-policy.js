            ...
            <div className="privacy-policy-area ptb-100">
                <div className="container">
                    <div className="privacy-policy-content">
                        ...
                        <p>This site is provided by <strong>TCloud Tech Solutions </strong>. <strong>Cloud Tech Solutions </strong> collects information in several ways from different parts of this site.</p>
                        ...
                        <p><strong>Cloud Tech Solutions </strong> accepts the following payment methods:</p>
                        <ul>
                            ...
                            <li><strong>Cloud Tech Solutions </strong> features a Fast Checkout option, allowing you to securely save your credit card details so that you don't have to re-enter them for future purchases.</li>
