                ...
                <div className="container">
                    <div className="feedback-tabs">
                        <Tabs>
                            ...
                            <TabPanel>
                                <p>The Cloud Tech Solutions  cloud based storage for your data backup just log in with your mail account from play store and using whatever you want for your business purpose orem ipsum dummy of your business purpose text.</p>
